...
const signature = await provider.send("eth_signTypedData_v4", [
  signerAddress, // A key accepted by the account's authentication logic
  JSON.stringify(data),
]);
```
